...
- 🧭 Organize educational materials into a **traceable, auditable training structure**  
...
- 🚫 Prevents unsafe delegation to AI or automated tools
...
| **Text Materials** | **CC BY 4.0 / CC BY-SA 4.0** | Attribution required; share-alike applies for BY-SA |
| **Figures & Diagrams** | **CC BY-NC 4.0** | Non-commercial use only |
| **External References** | Original license applies | Cite the original source properly |
...
[![💬 GitHub Discussions](https://img.shields.io/badge/💬%20GitHub-Discussions-brightgreen?logo=github)](https://github.com/Samizo-AITL/aitl-training/discussions)
